...
import { useGetInstitutionQuery } from "../../../store/api/institutionManagement/institutionApi"; // Import institution API
import { useGetIssuersQuery } from "../../../store/api/issuerManagement/issuerApi"; // Import issuer API
...
const ProfileInfoContainer = () => {
    ...
    // Fetching earner, institution, and issuer data based on userId
