...
const Testimonial = () => {
  return (
    <div style={{ padding: '0rem', backgroundColor: '#F9FBFF', maxWidth: '1200px', margin: 'auto', textAlign: 'center' }}>
                ...
                <Grid container spacing={2}>
                  <Grid item>
                    <Typography color="primary" variant="h3" component="div">
                      <FormatQuote sx={{ fontSize: '4rem', rotate: '180deg' }} />
                    </Typography>
                  </Grid>
                  <Grid item xs>
                    <Typography
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 500, color: theme.palette.text.disabled, fontSize: '0.85rem' }}>
                      {testimonial.author}
                    </Typography>
                    <Typography variant="body2" sx={{ fontWeight: 500, color: theme.palette.text.disabled, fontSize: '0.75rem' }}>
