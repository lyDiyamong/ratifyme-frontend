...
const TableReport = () => {
    ...
    const reportColumns =
        roleId === 1 ? [ // Admin Columns
            ...
            {
                name: "Issuer Name",
                selector: (row) => row.Issuers.map(issuer => `${issuer.User.firstName} ${issuer.User.lastName}`).join(', '),
                sortable: true,
            },
            {
                name: "Total Badge",
